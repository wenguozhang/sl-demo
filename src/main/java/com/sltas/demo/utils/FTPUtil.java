...
public class FTPUtil {  
	  private FTPClient ftpClient = null;
	    ...
	    public static void main(String[] args) {
	    	FTPUtil f = new FTPUtil("47.94.45.32", 50021, "front", "front#0s@WE223");
	    	System.out.println("连接状态"+f.open());
//	    	System.out.println(f.deleteFile("slzhxy01/slzhxy01"));
//	    	f.mkDir("test1");
//	    	
//	    	System.out.println(f.deleteDirectory("test"));
	        try {
	            if(f.open()) {
//	                String fileName = "测试2.txt";
//	                //上传
//	                f.upload("d:/QRCode1.png", fileName, "test1");
//
//	                //遍历
//	                FTPFile[] list = f.getFileList("/2017-07-22");
...
//	                }
	                ...
	                //下载
	                boolean b = f.get("/111257/20171019/111257_2_20171019.txt", "d:\\text.txt");
